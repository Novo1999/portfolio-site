   ...
   <div className="grid grid-cols-1 sm:grid-cols-12 relative md:top-6">
    <motion.div initial={{ opacity: 0, scale: 0 }} animate={{ opacity: 1, scale: 1 }} transition={{ duration: 0.5 }} className="col-span-7 place-self-center text-center sm:text-left">
     ...
     <div>
      ...
      <button className='px-1 py-1 w-full relative sm:w-fit rounded-full bg-transparent bg-gradient-to-br from-blue-500 via-teal-500 to-green-600 hover:bg-slate-800 text-white border mt-3'><a href='Novo-CV.docx' className='block bg-[#121212] hover:bg-slate-800 rounded-full px-5 py-2' download>Download CV</a></button>
     </div>
    </motion.div>
